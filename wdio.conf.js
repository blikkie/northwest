exports.config = {
  ...
  // - @wdio/sauce-service @wdio/mocha-framework, @wdio/jasmine-framework
  ...
  cucumberOpts: {
    ...
    requireModule: [], // <string[]> ("extension:module") require files with the given EXTENSION
    // after requiring MODULE (repeatable)
    ...
    ignoreUndefinedDefinitions: false, // <boolean> Enable this config to treat undefined
    // definitions as warnings.
  },
